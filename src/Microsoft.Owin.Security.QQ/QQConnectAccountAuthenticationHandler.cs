    ...
    internal class QQConnectAccountAuthenticationHandler : AuthenticationHandler<QQConnectAuthenticationOptions>
    {
        ...
        private async Task<bool> InvokeReturnPathAsync()
        {
            ...
            if (context.SignInAsAuthenticationType != null && context.Identity != null)
            {
                ...
                Context.Request.User = new ClaimsPrincipal(signInIdentity);
            ...
            if (!context.IsRequestCompleted && context.RedirectUri != null)
            {
                ...
                Context.Request.Headers.Add("x-redirect", new string[] { redirectUri });
                //Response.Redirect(redirectUri);
                //context.RequestCompleted();
            }

            return false;//context.IsRequestCompleted;
        }
        ...
        protected override async Task<AuthenticationTicket> AuthenticateCoreAsync()
        {
            ...
            try
            {
                ...
                if (!String.IsNullOrWhiteSpace(context.Avatar))
                {
                    var claim_type = string.Format("urn:{0}:avatar", Options.AuthenticationType.ToLower());//"urn:qq:avatar"
                    context.Identity.AddClaim(new Claim(claim_type, context.Avatar, XmlSchemaString, Options.AuthenticationType));
                }
