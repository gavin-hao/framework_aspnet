...
namespace Dongbo.OAuth.Core.OAuthTokenAuthenticationMiddleware
{
   ...
   public class OAuthTokenAuthenticationOptions : AuthenticationOptions
   {
       private const string DefaultAuthenticationType = "OAuthToken";
       /// <summary>
       /// Creates an instance of bearer authentication options with default values.
       /// </summary>
       public OAuthTokenAuthenticationOptions()
           : base(DefaultAuthenticationType)
       {
           SystemClock = new SystemClock();
           TokenEndpoint = new PathString("/auth/Link");
       ...
       public Microsoft.Owin.PathString TokenEndpoint { get; set; }
   }
}
