...
namespace Dongbo.DFS.Oss
{
    internal class Mime
    {
        ...
        public static string Lookup(string filePath)
        {
            ...
            var mimeType = Apache.MimeTypes.ContainsKey(extension) ? Apache.MimeTypes[extension] : "";
            if (!string.IsNullOrEmpty(mimeType))
                return mimeType;
            return defaultType;
            // Get a close match
            //mimeType =Apache.MimeTypes.FirstOrDefault(x => x.key.Exists(m => m.Contains(extension)));
            //if (string.IsNullOrEmpty(mimeType))
            //    return defaultType;
            //return mimeType;
        }
    ...
    class Apache
    {
        public static Dictionary<string, string> MimeTypes = new Dictionary<string, string>
		{
            ...
            { "dbk", "application/x-axe-document" },//axeslide application file type with extension .dbk 
			...
			{ "pdf", "application/pdf" },
            { "pez", "application/prezi" },//prezi document 
